...
2. **Platform overview:** citizen, NGO, government and relief web portals, anonymous public map, AWS infrastructure and Flutter app. Distinguish the new responsive web workflow from the Android client's existing SOS/routing support.
